...
int main(void) {
  ...
  while (!WindowShouldClose()) // Detect window close button or ESC key
  {
    ...
    DrawFPS(10, 10);
    DrawText("Camera controls:", 15, 25, 10, BLACK);
    DrawText("- Move keys: W, A, S, D, Space, Left-Ctrl", 15, 40, 10, BLACK);
    DrawText("- Look around: arrow keys or mouse", 15, 55, 10, BLACK);
